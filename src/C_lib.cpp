...
double TestLib::passDoubleArr(double d[]) {
    for(int i=0;i<5;i++) cout<<d[i]<<" ";
    cout<<endl;
    cout << d[1] << " in c++ Size: " <<  endl;
    return 1.23;
}
...
// g++ -o libTest.dll -shared -fPIC C_lib.cpp